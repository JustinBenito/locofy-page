...
const ListingDescription = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch box-border flex flex-col items-start justify-start pt-0 px-0 pb-[22px] gap-[20px] max-w-full text-left text-5xl text-dark font-archivo border-b-[1px] border-solid border-light-grey-border ${className}`}
    >
      <h3 className="m-0 self-stretch relative text-inherit tracking-[0.02em] font-semibold font-inherit mq450:text-lgi">
        About this home
      </h3>
      <div className="self-stretch flex flex-row items-start justify-start gap-[40px] max-w-full text-base mq750:gap-[20px] mq1275:flex-wrap">
        <div className="flex-1 flex flex-col items-start justify-start gap-[8px] min-w-[539px] max-w-full mq750:min-w-full">
          ...
          <a className="[text-decoration:none] relative tracking-[0.46px] leading-[26px] font-semibold text-accent text-center inline-block min-w-[88px]">
            Show more
          </a>
        </div>
        <div className="flex flex-col items-start justify-start py-0 pr-[139px] pl-0 box-border gap-[24px] min-w-[470px] max-w-full text-lg mq750:min-w-full mq1275:flex-1 mq1275:pr-0 mq1275:box-border">
          <DetailsCard
