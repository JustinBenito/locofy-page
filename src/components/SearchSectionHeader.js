...
const SearchSectionHeader = ({ className = "" }) => {
  return (
    <div
      className={`w-full flex flex-row items-center justify-between pt-3.5 px-0 pb-0 box-border max-w-[1280px] gap-[20px] text-left text-xl text-black font-archivo mq750:flex-wrap mq1275:max-w-full ${className}`}
    >
      ...
      <div className="w-[84px] rounded-4xs bg-white box-border flex flex-row items-center justify-start py-1 px-[5px] border-[0.7px] border-solid border-light-grey-border">
